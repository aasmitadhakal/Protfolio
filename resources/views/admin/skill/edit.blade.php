                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        placeholder="title" value="{{ old('title', $skill->title) }}" />
                                    @error('title')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="short_description"
                                        ...
                                        value="{{ old('short_description', $skill->short_description) }}" />
                                ...
                                <div class="mb-4 text-2xl">
                                    ...
                                    <input class="form-control" type="file" id="image" name="image"
                                        value="{{ old('image', $skill->image) }}" data-default-file
                                        class=""{{ asset($skill->image) }}" />
