                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="date_from" name="date_from"
                                        placeholder="date_from" value="{{ old('date_from', $experience->date_from) }}" />
                                    @error('date_from')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="date_to" name="date_to"
                                        placeholder="date_to" value="{{ old('date_to', $experience->date_to) }}" />
                                    @error('date_to')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="short_description" name="short_description" placeholder="Short Description"
                                        rows="4">{{ old('short_description', $experience->short_description) }}</textarea>
